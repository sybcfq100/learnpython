...
#
#
#  # return func2 和 funception 的目的分别是什么？
#
#  func2_1 = funception(func1, 3)(2)
#  print(func2_1)
#
#  def mul_by_num(num):
...
# lambda函数的优势不用定义变量，用完就丢掉，返回结果
#  """ alternative expression using other funcitons to represent lambda function"""
...
#
#
#  a1 = add_results(identity, square)
#  print(a1(4))
#  a2 = add_results(a1, identity)
#  print(a2(4))
#  print(a2(5))
#  a3 = add_results(a1, a2)
#  print(a3(4))
#
